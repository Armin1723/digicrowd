...
const WhoWeAre = () => {
  return (
    <div className="flex max-lg:flex-col bg-white max-sm:gap-6 w-full py-20 max-lg:py-12 max-sm:py-8 min-h-screen items-end">
      <div className="content w-1/2 max-lg:w-full flex flex-col items-center justify-center max-sm:px-4 gap-2">
        <div className="wrapper flex flex-col w-[80%] max-sm:w-full font-wix max-sm:px-4">
          ...
          <p className=" items-start text-justify text-lg pt-12 max-sm:pt-4 max-sm:text-sm font-['helvetica']">
        ...
        <div className="button-container flex w-4/5 items-start">
          <button
            ...
            className="rounded-lg px-6 py-2 text-lg font-bold max-sm:text-sm font-wix text-white bg-blue-600 hover:bg-blue-700 transition-all duration-300"
          >
            Read More
          </button>
        </div>
